...
curl -X PUT "https://10.10.162.25:9200/_cluster/settings"  -u admin:g4ewwP3nRV3eSL*fN9x+KAm6qQP8mShv -k -H 'Content-Type: application/json' -d'
{
  "persistent": {
...
curl -X POST "https://10.10.162.25:9200/_flush/synced" -u admin:g4ewwP3nRV3eSL*fN9x+KAm6qQP8mShv -k
echo -e "\r\n"
...
curl -k -u admin:g4ewwP3nRV3eSL*fN9x+KAm6qQP8mShv https://10.10.162.25:9200/_cat/nodes?v
echo -e "\r\n"
