...
curl -X PUT "https://10.10.20.51:9200/_cluster/settings"  -u admin:LyYZQAEV+U97lj+br4V3EN7WasZ.wY+o -k -H 'Content-Type: application/json' -d'
{
  "persistent": {
...
curl -X POST "https://10.10.20.51:9200/_flush/synced" -u admin:LyYZQAEV+U97lj+br4V3EN7WasZ.wY+o -k
echo -e "\r\n"
...
curl -k -u admin:LyYZQAEV+U97lj+br4V3EN7WasZ.wY+o https://10.10.20.51:9200/_cat/nodes?v
echo -e "\r\n"
